	 ...
	 <form method="post" action="action.php" onsubmit="return false" id="reg_step1">
	     ...
	     <div id="step1" class="d-none">
	         ...
	         <div class="progress-bar" role="progressbar" style="width: 33.3333s%" aria-valuenow="0" aria-valuemin="0"
	 ...
	 <button type="button" class="btn btn-light text-primary mt-2 back" style="font-size: 14px"> Already have an
	     account</button>
	 </div>
	 ...
	 <div id="step2" class="d-none">
	     ...
	     <div class="progress-bar" role="progressbar" style="width: 66.755%" aria-valuenow="0" aria-valuemin="0"
	         aria-valuemax="100"></div>
	     ...
	     <button type="button" data-step="2" class="btn btn-light form-control mb-1 py-2 mt-2" style="font-style: 16px">
	         Back</button>
