...
function remove_non_numeric($string) {
    return preg_replace("/[^0-9]/", "", $string);
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            $total_remit = $prev_total_remit + $cash_remit;


           
                           $sql = "UPDATE `courier_trans` SET `total_remit`='$prev_total_remit' , `total_cash_onhand`='$cash_remaining' WHERE user_id = '$user_id' and date='$datenow' ";
