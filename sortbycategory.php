...
<div class="row mt-4 d-none" id="item">
        ...
        <div class="card w-100" style="height:100%">
                ...
                $get_items_photo = " SELECT * FROM `photo` where prod_id = '$itemid' limit 1 ";
                                           ...
                                           if ($countproduct_photos>=1){
                                               ...
                                               while($photo= mysqli_fetch_array($productphotos)){
                                                ?>
            <img src="<?php echo 'img/products/'.$photo['photo'] ?>" class="card-img-top" alt="..."
                style="height: 280px">
            <?php
                                               }
                                        }else {
            ...
            <div class="card-body" style="text-align: center;">
                <a href="javascript:void(0)" data-bs-toggle="modal" class="openproductview"
                    data-id="<?php echo $row['prod_id'] ?>" data-bs-target="#exampleModal" data-backdrop="static"
            ...
            <div class="card-footer">
                <button class="btn btn-light text-info addcart" style="font-size: 13px;font-weight: bold;"
    ...
    <div class="container">
        <div style="text-align: center;">
            ...
            <h6 class="mt-4" style="font-weight: bolder;">No Items found in category <span
                    class="text-danger"><?php echo $categoryname ?></span></h6>
        </div>
