    ...
    ?>
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="quantity mt-3" style="float: right;">
                                    ...
                                    <button class="btn btn-dark plus" data-qty="<?php echo $qty ?>"
                                        data-price="<?php echo $item['price'] ?>" data-cartid="<?php echo $cartid ?>"
                                    ...
                                    <button class="btn btn-dark minus" data-qty="<?php echo $qty ?>"
                                        data-price="<?php echo $item['price'] ?>" data-total="<?php echo $total ?>"
                                        data-cartid="<?php echo $cartid ?>"
                                        data-productid="<?php echo $item['prod_id'] ?>"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group"> <label for="cc-exp" class="control-label">CARD EXPIRY</label>
                                    <input id="cc-exp" type="tel" class="input-lg form-control cc-exp di"
                                        autocomplete="cc-exp" placeholder="•• / ••" required maxlength="4"
                                        oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"> <label for="cc-cvc" class="control-label">CARD CVC</label>
                                    <input id="cc-cvc" type="tel" class="input-lg form-control cc-cvc di"
