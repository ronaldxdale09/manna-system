          ...
          while ($rowactive = mysqli_fetch_array($result_of_getactive)) {
              ...
              ?>
										...
										<div class="carousel-item active">
											...
											<center>
												<div class="circle">
													<img src="<?php echo $src; ?>" alt="" class="card-img-top" style="width:100px;height: 100px">
												</div>
											</center>
										</div>
   ...
   ?>
    ...
    "code"
             ...
             echo "No code available";
							...
							<br>
							<hr>
							<span style="font-size: 15px; font-weight: bolder">TOTAL : <span class="float-right" id="totalamount" style="margin-left: 20px;font-size: 17px">₱ <?php if (
           isset($totalamount)
       ) { ?>
		...
		<div class="modal-content">
           ...
           ?>
                  ...
                  echo "0";
                                    ...
                                    if (date("Y-m-d", strtotime($ed)) < $datenow) {
                                            ...
                                            ?>
															<option value="<?php echo $ds; ?>"><?php echo $pc["code"]; ?>
																(<span style="float: right;color:red" class="text-danger">-₱<?php echo $ds; ?></span>)
															</option>
							...
							<button type="button" id="codbtn" class="btn btn-dark mt-3 form-control py-2" style="font-size: .8rem;">PLACE ORDER</button>
