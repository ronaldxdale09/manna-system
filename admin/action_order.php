	                 ...
	                 while($row = mysqli_fetch_array($gettingcategories)){
	                 	...
	                 	$tid = $row['tid'];
							...
							if($pm == 'reserve') {
								...
								if($stat == 'pending'){
									?>
									<button class="btn btn-light text-primary confirmd" data-od="<?php echo $tid ?>" style="font-size: 14px;font-weight: bolder;">Confirm</button>
									<?php
								}else if ($stat == 'ready'){
									...
									<?php
										...
										?>
									<h6 class="text-success" style="font-size: 13px;font-weight: bolder;">Waiting For the Courier...</h6>
									<?php
								}
